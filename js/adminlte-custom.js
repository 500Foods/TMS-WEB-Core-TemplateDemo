...
(function (global, factory) {
    ...
    class PushMenu {
        ...
        sidebarHover() {
            ...
            if (selSidebar) {
                window.addCUSTOMEventListener(selSidebar,'mouseover', () => {
                    this._bodyClass.add(CLASS_NAME_SIDEBAR_IS_HOVER);
                });
                window.addCUSTOMEventListener(selSidebar,'mouseout', () => {
        ...
        init() {
            ...
            if (targetContentWrapper) {
                window.addCUSTOMEventListener(targetContentWrapper,'touchstart', this.removeOverlaySidebar);
                window.addCUSTOMEventListener(targetContentWrapper,'click', this.removeOverlaySidebar);
            }
        }
    }
    /**
    ...
    domReady(() => {
        ...
        for (const btn of fullBtn) {
             window.addCUSTOMEventListener(btn,'click', event => {
